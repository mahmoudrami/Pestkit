        ...
        <div class="row g-5">
            ...
            <div class="col-xxl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay=".3s">
                <div class="rounded team-item">
                    <img src="{{ $one->image_path }}" class="img-fluid w-100 rounded-top border border-bottom-0" alt="">
                    <div class="team-content bg-primary text-dark text-center py-3">
                        <span class="fs-4 fw-bold">{{ $one->name }}</span>
                        <p class="text-muted mb-0">{{ $one->perfession }}</p>
                    </div>
