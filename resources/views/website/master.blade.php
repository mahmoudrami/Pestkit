                ...
                <div class="d-flex justify-content-between topbar py-2">
                    <div class="d-flex align-items-center flex-shrink-0 topbar-info">
                        <a href="#" class="me-4 text-secondary"><i
                                class="fas fa-map-marker-alt me-2 text-dark"></i>{{ $setting->location }}</a>
                        <a href="#" class="me-4 text-secondary"><i
                                class="fas fa-phone-alt me-2 text-dark"></i>{{ $setting->phone }}</a>
                        <a href="#" class="text-secondary"><i
                                class="fas fa-envelope me-2 text-dark"></i>{{ $setting->email }}</a>
                    </div>

                    <div class="d-flex align-items-center justify-content-center topbar-icon">
                        <a href="{{ $setting->facebook }}" class="me-4"><i
                                class="fab fa-facebook-f text-dark"></i></a>
                        <a href="{{ $setting->twiter }}" class="me-4"><i class="fab fa-twitter text-dark"></i></a>
                        <a href="{{ $setting->instagram }}" class="me-4"><i
                                class="fab fa-instagram text-dark"></i></a>
                        <a href="{{ $setting->linkedin }}" class=""><i
                    ...
                    <div class="collapse navbar-collapse me-n3" id="navbarCollapse">
                        <div class="navbar-nav ms-auto">
                            <a href="{{ route('homePage') }}"
                                class="nav-item nav-link {{ Route::currentRouteName() == 'homePage' ? 'active' : '' }}">Home</a>
                            <a href="{{ route('about') }}"
                                class="nav-item nav-link {{ Route::currentRouteName() == 'about' ? 'active' : '' }}">About</a>
                            <a href="{{ route('Services') }}"
                                class="nav-item nav-link {{ Route::currentRouteName() == 'Services' ? 'active' : '' }}">Services</a>
                            <a href="{{ route('Projects') }}"
                                class="nav-item nav-link {{ Route::currentRouteName() == 'Projects' ? 'active' : '' }}">Projects</a>
                            <div class="nav-item dropdown">
                                <a href="#"
                                    class="nav-link dropdown-toggle {{ Str::contains(Route::currentRouteName(), 'page') ? 'active' : '' }}"
                                    data-bs-toggle="dropdown">Pages</a>

                                <div class="dropdown-menu m-0 bg-primary">
                                    <a href="{{ route('page.Pricing') }}"
                                        class="dropdown-item {{ Str::contains(Route::currentRouteName(), 'Pricing') ? 'active' : '' }}">Pricing
                                        Plan</a>
                                    <a href="{{ route('page.blogs') }}"
                                        class="dropdown-item {{ Str::contains(Route::currentRouteName(), 'blogs') ? 'active' : '' }}">Blog
                                        Post</a>
                                    <a href="{{ route('page.members') }}"
                                        class="dropdown-item {{ Str::contains(Route::currentRouteName(), 'members') ? 'active' : '' }}">Team
                                        Members</a>
                                    <a href="{{ route('page.testimonials') }}"
                                        class="dropdown-item {{ Str::contains(Route::currentRouteName(), 'testimonials') ? 'active' : '' }}">Testimonial</a>
                                </div>
                            </div>
                ...
                <div class="row g-4 footer-inner">
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <p class="mb-0"><a class="" href="#">PestKit </a> &copy; 2023 All Right
                                Reserved.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <div class="d-flex flex-column align-items-start">
                                <a class="btn btn-link ps-0" href="{{ route('about') }}"><i
                                        class="fa fa-check me-2"></i>About Us</a>
                                <a class="btn btn-link ps-0" href="{{ route('Contact') }}"><i
                                        class="fa fa-check me-2"></i>Contact Us</a>
                                <a class="btn btn-link ps-0" href="{{ route('Services') }}"><i
                                        class="fa fa-check me-2"></i>Our Services</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <div class="d-flex flex-column align-items-start">
                                ...
                                @foreach (App\Models\Service::take(4)->get() as $one)
                                    <a class="btn btn-link ps-0" href="{{ route('Services') }}"><i
                                            class="fa fa-check me-2"></i>{{ $one->name }}</a>
                                @endforeach
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <a href="{{ route('Contact') }}"
                                class="btn btn-link w-100 text-start ps-0 pb-3 border-bottom rounded-0"><i
                                    class="fa fa-map-marker-alt me-3"></i>{{ $setting->location }}</a>
                            <a href="{{ route('Contact') }}"
                                class="btn btn-link w-100 text-start ps-0 py-3 border-bottom rounded-0"><i
                                    class="fa fa-phone-alt me-3"></i>{{ $setting->phone }}</a>
                            <a href="{{ route('Contact') }}"
                                class="btn btn-link w-100 text-start ps-0 py-3 border-bottom rounded-0"><i
                                    class="fa fa-envelope me-3"></i>{{ $setting->email }}</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 text-center text-md-start mb-3 mb-md-0">
                        <a href="{{ route('homePage') }}" class="text-primary mb-0 display-6">Pest<span
                                class="text-white">Kit</span><i class="fa fa-spider text-primary ms-2"></i></a>
                    </div>
                    <div class="col-md-4 copyright-btn text-center text-md-start mb-3 mb-md-0 flex-shrink-0">
                        <a class="btn btn-primary rounded-circle me-3 copyright-icon"
                            href="{{ $setting->twiter }}"><i class="fab fa-twitter"></i></a>
                        <a class="btn btn-primary rounded-circle me-3 copyright-icon"
