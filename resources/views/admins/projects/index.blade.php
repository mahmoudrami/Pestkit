...
@section('content')
    ...
    <div class="d-flex justify-content-between mb-3">
        ...
        <a href="{{ route('admin.projects.create') }}" class="btn btn-secondary mr-5 h-75 p-2">add new</a>
    </div>
    @if (session('msg'))
    ...
    <table class="table table-hover table-bordderd ">
        ...
        @foreach (@$items as $item)
            <tr>
                ...
                <th>{{ @$item->name }}</th>
                <th>
                    <a href="{{ route('admin.projects.edit', @$item->id) }}" class="btn btn-primary"><i class="fas fa-edit"></i></a>
